...
export const slashCommands: SlashCommand[] = [
  ...
  { name: 'goal', description: 'Show or control the current session goal' },
  { name: 'kanban', description: 'Manage durable kanban boards and task dispatch' },
  { name: 'checkpoint', description: 'Preview or restore filesystem checkpoints' },
  { name: 'cron', description: 'Control supervised scheduled runs' },
  { name: 'approval', description: 'Approve or deny pending tool approvals' },
