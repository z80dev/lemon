...
export function createMockConnection() {
  ...
  return Object.assign(emitter, {
    ...
    goalLoopStart: vi.fn(),
    goalLoopStop: vi.fn(),
    goalLoopStatus: vi.fn(),
    goalClear: vi.fn(),
    kanbanBoardList: vi.fn(),
    kanbanBoardCreate: vi.fn(),
    kanbanBoardGet: vi.fn(),
    kanbanBoardArchive: vi.fn(),
    kanbanTaskCreate: vi.fn(),
    kanbanTaskUpdate: vi.fn(),
    kanbanTaskComment: vi.fn(),
    kanbanDispatcherStart: vi.fn(),
    kanbanDispatcherStatus: vi.fn(),
    kanbanDispatcherStop: vi.fn(),
