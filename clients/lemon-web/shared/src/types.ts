...
export interface BridgeStderrMessage {
  type: 'bridge_stderr';
  message: string;
}

export type BridgeMessage = BridgeStatusMessage | BridgeErrorMessage | BridgeStderrMessage;

/** Messages that the web UI can receive via WebSocket. */
export type WireServerMessage = (ServerMessage | BridgeMessage) & ServerTimeStamp;
