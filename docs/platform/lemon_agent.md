...
defining a tool, driving the loop, spawning subagents, and the `AgentCore.Workspace.*`
stores. Source today is `apps/agent_core` plus three stores moving out of `lemon_core`.
