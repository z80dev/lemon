%{
  ...
  entries: [
    ...
    %{path: "docs/architecture_boundaries.md", last_reviewed: ~D[2026-09-01], max_age_days: 60},
    ...
    %{path: "docs/mix-tasks.md", last_reviewed: ~D[2026-09-01], max_age_days: 180},
    ...
    %{path: "docs/architecture/overview.md", last_reviewed: ~D[2026-09-01], max_age_days: 60},
    ...
    %{
      path: "docs/platform/owned-storage.md",
      last_reviewed: ~D[2026-09-01],
      max_age_days: 120
    },
    %{
      path: "docs/platform/run-ownership.md",
      last_reviewed: ~D[2026-09-01],
      max_age_days: 120
    },
    %{
