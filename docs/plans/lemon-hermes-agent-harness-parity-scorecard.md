...
1. Add a live-model cron eval that proves an independent model respects the blocked cron tool surface.
2. Add live-model delegation evals that prove independent model behavior across parallel child tasks.
