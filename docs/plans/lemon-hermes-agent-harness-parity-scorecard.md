...
- Gaps:
  ...
  - Need broader parallel-research evals that aggregate multiple child results.
...
3. Add a broader parallel-research eval that joins and aggregates multiple child task results.
