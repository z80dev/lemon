...
Latest slice: Standalone LemonRunner tool completion events preserve structured `AgentToolResult.details` metadata instead of dropping it when no start event was tracked.
