...
Latest slice: Malformed OpenAI Responses streamed function calls now receive stable tool ids and an `unknown_tool` name when provider identity fields are missing.
