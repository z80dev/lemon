...
2. Continue provider-weirdness regressions for truncated tool-call args, retry-after/rate-limit paths, context overflow, and provider-normalized response errors.
