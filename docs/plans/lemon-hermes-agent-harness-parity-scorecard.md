...
Latest slice: Provider error bodies with FastAPI-style `detail` arrays or nested `details` arrays are normalized into clean provider messages instead of inspected maps.
