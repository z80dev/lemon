...
Latest slice: shared provider error parsing now treats provider-body rate-limit and overloaded messages as retryable contracts even when the HTTP status is a generic client error.
