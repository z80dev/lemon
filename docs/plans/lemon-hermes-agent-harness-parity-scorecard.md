...
- Gaps:
  - Job toolset restriction still needs evaluation.
  - Recursive scheduling is prompt-guarded, but not yet enforced structurally.
...
2. Add cron toolset-restriction validation and structural recursive-scheduling enforcement.
