...
Latest slice: Malformed OpenAI-compatible streamed function calls now receive stable fallback tool ids and an `unknown_tool` name when provider identity fields are missing.
