...
3. Add behavioral evals that observe the remaining actual agent traces: prior-work prompt → `search_memory`, async task receipt → `join` before final answer.
