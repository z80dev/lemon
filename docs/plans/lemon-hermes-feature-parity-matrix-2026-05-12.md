...
1. **Browser Worker Vertical Slice**
   - Started: `clients/lemon-browser-node` is used through
     `LemonCore.Browser.LocalServer`, an OTP-supervised local driver.
