...
This is the generated reference for every environment variable Lemon reads today, grouped by area. It is produced from the declarations in [`LemonCore.Env`](../apps/lemon_core/lib/lemon_core/env.ex) (`LemonCore.Env.all_declared/0`) -- that module is the source of truth; this file documents it for humans.
