...
|---|---|---|---|---|---|---|---|
| [PLN-20260226-agent-games-platform](plans/PLN-20260226-agent-games-platform.md) | Agent-vs-Agent Game Platform (REST API + Live Spectator Web) | `in_progress` | `janitor` | `feature/pln-20260226-agent-games-platform` | `pending` | — | 2026-02-28 |
