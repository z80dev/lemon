...
| [PLN-20260222-debt-phase-13-client-ci-parity-governance](plans/PLN-20260222-debt-phase-13-client-ci-parity-governance.md) | Debt Phase 13 - Client CI parity and dependency governance | `in_progress` | `janitor` | `feature/pln-20260222-debt-phase-13-m7-eslint-parity-2` | `pending` | `debt_plan.md:200` | 2026-02-25 |
