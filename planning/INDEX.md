...
Last updated: 2026-02-25 (phase-09/10 landed; phase-13 + runtime-hot-reload ready_to_land; long-running harnesses M5 integrated)
...
| [PLN-20260224-long-running-agent-harnesses](plans/PLN-20260224-long-running-agent-harnesses.md) | Long-Running Agent Harnesses and Task Management | `in_progress` | `janitor` | `feature/pln-20260224-long-running-harnesses` | `pending` | — | 2026-02-25 |
