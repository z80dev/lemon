...
## Integration Order
- Preferred: `M2 -> M3 -> M4` as separate stacked landings.
- Alternative: a single landing of the stacked chain if workspace hygiene is preserved.
...
- [x] Final landing execution + post-landing smoke check

## Notes
- M1 code landed on `main` as commit `62144b29`.
...
- Final stacked landing completed in order `M2 -> M3 -> M4`; `main` now points to `bec7bfae0281c23e616148c191c287a79362b7e4`.
- Post-landing smoke test passed: `mix test apps/lemon_core/test/lemon_core/introspection_test.exs apps/lemon_core/test/lemon_core/store_test.exs` (18 tests, 0 failures).
