defmodule LemonSim.Examples.IntelNetwork.GameLog do
  @moduledoc false
  ...
  # Strip the mole's hidden role from world snapshots for non-replay contexts.
  # The full role is preserved in the log so replays can show it at end.
  defp sanitize_world(world) do
    world
  end
