defmodule LemonSim.Examples.Poker.Engine.Table do
  @moduledoc """
  ...
  alias LemonSim.Examples.Poker.Engine.{Card, Deck, HandRank}
  ...
  defmodule SeatPlayer do
    ...
    @type t :: %__MODULE__{
            ...
            status: LemonSim.Examples.Poker.Engine.Table.seat_status()
          }
  end
  ...
  defmodule HandPlayer do
    ...
    @type t :: %__MODULE__{
            ...
            player_id: String.t(),
            stack: non_neg_integer(),
            hole_cards: [LemonSim.Examples.Poker.Engine.Card.t()],
  ...
  defmodule Hand do
    ...
    @type t :: %__MODULE__{
            ...
            deck: [LemonSim.Examples.Poker.Engine.Card.t()],
            board: [LemonSim.Examples.Poker.Engine.Card.t()],
            pot: non_neg_integer(),
