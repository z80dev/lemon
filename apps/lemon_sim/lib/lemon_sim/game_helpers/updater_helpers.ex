defmodule LemonSim.GameHelpers.UpdaterHelpers do
  ...
  defdelegate ensure_role(players, player_id, expected_role),
    to: LemonSim.Examples.Helpers.UpdaterHelpers

  defdelegate ensure_not_role(players, player_id, forbidden_role),
    to: LemonSim.Examples.Helpers.UpdaterHelpers
  ...
  defdelegate reject_action(state, event, player_id, reason),
    to: LemonSim.Examples.Helpers.UpdaterHelpers
