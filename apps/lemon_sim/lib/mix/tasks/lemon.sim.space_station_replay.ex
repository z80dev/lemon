defmodule Mix.Tasks.Lemon.Sim.SpaceStationReplay do
  @shortdoc "Generates a video replay from a Space Station game log"
  @moduledoc """
  Renders a Space Station game transcript (JSONL) into an MP4 video.

  ## Usage

      mix lemon.sim.space_station_replay path/to/space_station.jsonl [options]
  ...
  alias LemonSim.Examples.SpaceStation.VideoGenerator
