defmodule Mix.Tasks.Lemon.Sim.DiplomacyReplay do
  @shortdoc "Generates a video replay from a Diplomacy game log"
  @moduledoc """
  Renders a Diplomacy game transcript (JSONL) into an MP4 video.

  ## Usage

      mix lemon.sim.diplomacy_replay path/to/diplomacy.jsonl [options]
  ...
  alias LemonSim.Examples.Diplomacy.VideoGenerator
