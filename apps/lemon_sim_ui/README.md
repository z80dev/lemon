...
- Meeting requests are preferences: mutual requests resolve first, then non-conflicting directed requests. Evidence is a calibrated noisy lead with a visible reliability label, never an undisclosed Doctor/Seer-action artifact.
