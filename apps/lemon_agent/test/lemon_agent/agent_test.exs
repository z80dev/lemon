defmodule LemonAgent.AgentTest do
  use ExUnit.Case, async: true
  import ExUnit.CaptureLog

  alias LemonAgent.Agent
  ...
  describe "start_link/1" do
    ...
    test "falls back to default queue_call_timeout for invalid values" do
      ...
      assert log =~ "Invalid LemonAgent.Agent queue_call_timeout=0"
    end
  end
  ...
  describe "prompt/2" do
    ...
    test "string prompt creates a UserMessage struct" do
      ...
      assert [%LemonAi.Types.UserMessage{content: "Structured input please"}] = user_messages
    end
