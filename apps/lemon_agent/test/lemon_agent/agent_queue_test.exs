defmodule LemonAgent.AgentQueueTest do
  @moduledoc """
  Comprehensive tests for queue mode handling in LemonAgent.Agent.
  ...
  describe "error state propagation in queue mode" do
    ...
    test "error in tool execution propagates to agent state" do
      error_tool = %LemonAgent.Types.AgentTool{
        name: "failing_tool",
  ...
  describe "steering vs follow-up message interaction" do
    test "steering messages have priority over follow-up" do
      ...
      slow_tool = %LemonAgent.Types.AgentTool{
        name: "slow_op",
        ...
        execute: fn _id, _params, _signal, _on_update ->
          ...
          %LemonAgent.Types.AgentToolResult{
            content: [%LemonAi.Types.TextContent{type: :text, text: "Done"}]
          }
        end
      }
