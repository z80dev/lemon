defmodule LemonAgent.SubagentSupervisorTest do
  @moduledoc """
  Comprehensive tests for LemonAgent.SubagentSupervisor.
  ...
  alias LemonAgent.AgentRegistry
  ...
  describe "supervisor initialization" do
    test "supervisor is running on application start" do
      ...
      assert Process.alive?(Process.whereis(LemonAgent.SubagentSupervisor))
    end

    test "supervisor uses DynamicSupervisor" do
      supervisor_pid = Process.whereis(LemonAgent.SubagentSupervisor)
  ...
  # ============================================================================
  # 8. Integration with LemonAgent.Agent
  # ============================================================================

  describe "integration with LemonAgent.Agent" do
    test "started subagent responds to Agent API" do
      ...
      :ok = LemonAgent.Agent.set_system_prompt(pid, "Updated")
      updated_state = LemonAgent.Agent.get_state(pid)
    ...
    test "subagent can process prompts" do
      ...
      :ok = LemonAgent.Agent.prompt(pid, "Hello!")
      :ok = LemonAgent.Agent.wait_for_idle(pid, timeout: 5000)
