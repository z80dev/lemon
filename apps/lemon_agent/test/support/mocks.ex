defmodule LemonAgent.Test.Mocks do
  @moduledoc """
  Mock modules and helper functions for testing LemonAgent.
  """
  ...
  # Convert a response to an event stream (simulating LemonAi.EventStream)
  ...
  defp empty_event_stream do
    ...
    Task.start(fn ->
      LemonAi.EventStream.complete(stream, assistant_message("", stop_reason: :stop))
    end)
