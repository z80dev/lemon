defmodule LemonAgent.AgentRegistryTest do
  @moduledoc """
  Comprehensive tests for LemonAgent.AgentRegistry module.
  ...
  describe "via/1" do
    ...
    test "via tuple can be used for GenServer registration" do
      ...
      # Start a simple Agent (not LemonAgent.Agent, just Elixir's Agent)
  ...
  describe "registry_name/0" do
    test "returns the registry module name" do
      assert AgentRegistry.registry_name() == LemonAgent.AgentRegistry
    end
  end
