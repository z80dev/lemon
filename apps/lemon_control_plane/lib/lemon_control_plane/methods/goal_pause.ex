defmodule LemonControlPlane.Methods.GoalPause do
  @moduledoc """
  Handler for `goal.pause`.
  """

  @behaviour LemonControlPlane.Method

  @impl true
  def name, do: "goal.pause"
  ...
  def handle(params, _ctx) do
    ...
    if is_nil(session_key) or String.trim(to_string(session_key)) == "" do
      ...
      case LemonAgent.Workspace.GoalStore.pause(session_key, run_id: param(params, "runId")) do
