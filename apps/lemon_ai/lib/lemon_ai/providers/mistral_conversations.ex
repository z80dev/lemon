defmodule LemonAi.Providers.MistralConversations do
  @moduledoc """
  ...
  alias LemonAi.Types.{Model, StreamOptions, Context}
  ...
  def stream(%Model{} = model, %Context{} = context, %StreamOptions{} = options) do
    ...
    LemonAi.Providers.OpenAICompletions.stream(adjusted_model, context, options)
  end
end
