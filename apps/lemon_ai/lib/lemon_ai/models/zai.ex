defmodule LemonAi.Models.ZAI do
  @moduledoc """
  Model definitions for the ZAI provider.

  The catalog is data: `priv/models/zai.json`, loaded at compile time by
  ...
  @external_resource Catalog.path("zai.json")
  @models Catalog.load!("zai.json")
