defmodule LemonAi.Models.Kimi do
  @moduledoc """
  Model definitions for the Kimi provider.

  The catalog is data: `priv/models/kimi.json`, loaded at compile time by
  ...
  @external_resource Catalog.path("kimi.json")
  @models Catalog.load!("kimi.json")
