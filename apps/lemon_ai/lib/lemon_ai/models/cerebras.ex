defmodule LemonAi.Models.Cerebras do
  @moduledoc """
  Model definitions for the Cerebras provider.

  The catalog is data: `priv/models/cerebras.json`, loaded at compile time by
  ...
  @external_resource Catalog.path("cerebras.json")
  @models Catalog.load!("cerebras.json")
