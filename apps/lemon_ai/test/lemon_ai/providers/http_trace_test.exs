defmodule LemonAi.Providers.HttpTraceTest do
  @moduledoc """
  Tests for pure functions in LemonAi.Providers.HttpTrace.
...
defmodule LemonAi.Providers.HttpTraceEnabledTest do
  @moduledoc """
  Tests for LemonAi.Providers.HttpTrace.enabled?/0.
