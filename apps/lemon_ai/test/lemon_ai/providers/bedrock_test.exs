defmodule LemonAi.Providers.BedrockTest do
  @moduledoc """
  Tests for LemonAi.Providers.Bedrock provider callbacks and registration.
  ...
  alias LemonAi.Providers.Bedrock
  ...
  describe "register/0" do
    test "registers the provider in ProviderRegistry" do
      ...
      assert {:ok, Bedrock} = LemonAi.ProviderRegistry.get(:bedrock_converse_stream)
    end
  end
  ...
  describe "behaviour" do
    test "implements LemonAi.Provider behaviour" do
      behaviours =
        Bedrock.__info__(:attributes)
        |> Keyword.get_values(:behaviour)
        |> List.flatten()

      assert LemonAi.Provider in behaviours
    end
  end
end
...
defmodule LemonAi.Providers.BedrockStreamTest do
  @moduledoc """
  Tests for LemonAi.Providers.Bedrock streaming and credential handling.
  ...
  alias LemonAi.Providers.Bedrock
  alias LemonAi.Types.{Context, Model, StreamOptions, Usage, Cost}
