defmodule LemonAi.ProviderTest do
  @moduledoc """
  Tests for the LemonAi.Provider behaviour.
  ...
  describe "real provider implementations" do
    test "Anthropic provider adheres to behaviour" do
      assert_behaviour_implementation(LemonAi.Providers.Anthropic)
    end

    test "OpenAIResponses provider adheres to behaviour" do
      assert_behaviour_implementation(LemonAi.Providers.OpenAIResponses)
    end

    test "Google provider adheres to behaviour" do
      assert_behaviour_implementation(LemonAi.Providers.Google)
    end

    test "GoogleVertex provider adheres to behaviour" do
      assert_behaviour_implementation(LemonAi.Providers.GoogleVertex)
    end

    test "GoogleGeminiCli provider adheres to behaviour" do
      assert_behaviour_implementation(LemonAi.Providers.GoogleGeminiCli)
    end

    test "Bedrock provider adheres to behaviour" do
      assert_behaviour_implementation(LemonAi.Providers.Bedrock)
    end

    test "AzureOpenAIResponses provider adheres to behaviour" do
      assert_behaviour_implementation(LemonAi.Providers.AzureOpenAIResponses)
    end

    test "OpenAICompletions provider adheres to behaviour" do
      assert_behaviour_implementation(LemonAi.Providers.OpenAICompletions)
    end

    test "OpenAICodexResponses provider adheres to behaviour" do
      assert_behaviour_implementation(LemonAi.Providers.OpenAICodexResponses)
    end
  end
  ...
  describe "provider metadata consistency" do
    test "all providers have unique api_ids" do
      providers = [
        ...
        LemonAi.Providers.GoogleGeminiCli,
