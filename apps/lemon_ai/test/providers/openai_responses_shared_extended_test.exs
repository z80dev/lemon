defmodule LemonAi.Providers.OpenAIResponsesSharedExtendedTest do
  @moduledoc """
  ...
  describe "convert_tools/2" do
    ...
    test "converts multiple tools" do
      tools = [
        %LemonAi.Types.Tool{name: "tool_a", description: "A", parameters: %{}},
        %LemonAi.Types.Tool{name: "tool_b", description: "B", parameters: %{}},
        %LemonAi.Types.Tool{name: "tool_c", description: "C", parameters: %{}}
      ]
