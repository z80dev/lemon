defmodule LemonCli.Setup.SetupTaskTest do
  ...
  describe "gateway subcommand" do
    test "remains a functional source-checkout adapter" do
      {io, get_log} = collect_io()
      assert :ok = SetupTask.run_with_io(["gateway", "--non-interactive"], io)
      log = get_log.()
