defmodule LemonCli.Onboarding.Providers do
  ...
  @providers [
    %Provider{
      ...
      oauth_module: LemonAi.Auth.AnthropicOAuth,
    ...
    %Provider{
      ...
      oauth_module: LemonAi.Auth.OpenAICodexOAuth,
      auth_modes: [:oauth, :api_key],
      default_auth_mode: :oauth,
    ...
    %Provider{
      ...
      oauth_module: LemonAi.Auth.GitHubCopilotOAuth,
      auth_modes: [:oauth, :api_key],
      default_auth_mode: :oauth,
    ...
    %Provider{
      ...
      oauth_module: LemonAi.Auth.GoogleAntigravityOAuth,
      auth_modes: [:oauth, :api_key],
      default_auth_mode: :oauth,
    ...
    %Provider{
      ...
      oauth_module: LemonAi.Auth.GoogleGeminiCliOAuth,
      auth_modes: [:oauth, :api_key],
      default_auth_mode: :oauth,
      preferred_models: [
        "gemini-2.5-pro",
