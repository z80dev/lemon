defmodule LemonGateway.Engines.Droid do
  ...
  def start_run(job, opts, sink_pid) do
    CliAdapter.start_run(AgentCore.CliRunners.DroidRunner, id(), job, opts, sink_pid)
  end
