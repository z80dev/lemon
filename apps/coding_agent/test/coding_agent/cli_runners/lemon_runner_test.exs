defmodule CodingAgent.CliRunners.LemonRunnerTest do
  ...
  describe "ResumeToken for lemon engine" do
    ...
    # Vendor engines (claude/kimi) register their resume syntax through
    # LemonCore.ResumeFormats when lemon_cli_runners boots, which is not a dep
    # of coding_agent. Vendor syntax is covered by
    # apps/lemon_cli_runners/test/lemon_cli_runners/resume_formats_test.exs.
