defmodule LemonCore.Env do
  ...
  @declarations [
    ...
    %{
      ...
      default: nil,
      doc:
        "Root directory under which each arena domain's league dir defaults to `<domain>_league`.",
      secret?: false,
      required?: false,
      area: :arena,
      apps: [:lemon_sim_ui]
    ...
    %{
      ...
      type: :string,
      default: nil,
      doc: "Bearer token required to access the LemonSimUi HTTP API.",
      secret?: true,
      required?: false,
      area: :endpoints,
      apps: [:lemon_sim_ui]
    ...
    %{
      ...
      type: :string,
      default: "localhost",
      doc: "Public hostname for the LemonSimUi prod endpoint.",
      secret?: false,
      required?: false,
      area: :endpoints,
      apps: [:lemon_sim_ui]
    ...
    %{
      ...
      type: :string,
      default: nil,
      doc: "Phoenix secret_key_base for the LemonSimUi prod endpoint.",
      secret?: true,
      required?: false,
      area: :endpoints,
      apps: [:lemon_sim_ui]
    ...
    %{
      ...
      type: :string,
      default: nil,
      doc: "Override path for the primary JSONL/SQLite data store.",
      secret?: false,
      required?: false,
      area: :store,
      apps: [:lemon_core]
